...
public class DrawingEventHandler implements MouseListener, MouseMotionListener {
	...
	public void mouseReleased(MouseEvent e) {
		switch (currentTool) {
		case TOOL_RECTANGLE:
			drawingBoard.addFigure(new Rectangle(new Point(tempX, tempY), new Point(e.getX(), e.getY())));
			break;
		case TOOL_OVAL:
			drawingBoard.addFigure(new Oval(new Point(tempX, tempY), new Point(e.getX(), e.getY())));
			break;
		case TOOL_LINE:
			drawingBoard.addFigure(new Line(new Point(tempX, tempY), new Point(e.getX(), e.getY())));
			break;
		case TOOL_GOURMETRAY:
			drawingBoard.addFigure(new GourmetRay(points));
			points.clear();
			break;
		case TOOL_SG:
